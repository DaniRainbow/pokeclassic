...
const u32 gItemIcon_PowerStone[] = INCBIN_U32("graphics/items/icons/power_stone.4bpp.lz");
const u32 gItemIconPalette_PowerStone[] = INCBIN_U32("graphics/items/icon_palettes/power_stone.gbapal.lz");
